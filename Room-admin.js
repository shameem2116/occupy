...
app.post('/VIEW', function (req, res) {
  ...
  connection.connect(function(err) {
    if (err) throw err;
 connection.query("SELECT * FROM Room where sem='"+sem0+"'and room='"+r1+"' and year='"+y0+"' ", function (err, result, fields) {
  if (err) throw err;
  console.log(result);
  ...
  res.render('C:/Users/Shameem Banu/formvalid/src/roomtimetable.ejs', {records:result });
 console.log("success");
});});});
...
app.post("/INSERT", function(req, res) {
  ...
  connection.connect(function(err){
    if (err) throw err; 
 var sql2 = "INSERT INTO Room (room_no,sem,year,day,fir_hr, sec_hr,thi_hr,fou_hr,fif_hr,six_hr,sev_hr,eig_hr,nin_hr) VALUES ('"+req.body.r2+"','"+req.body.sem1+"','"+req.body.y1+"','"+req.body.day1+"','"+req.body.fh1+"','"+req.body.sh1+"','"+req.body.th1+"','"+req.body.foh1+"','"+req.body.fih1+"','"+req.body.sih1+"','"+req.body.seh1+"','"+req.body.eh1+"','"+req.body.nh1+"')";
...
// var sql2 = "UPDATE Room set fir_hr='"+fh2+"' where room_no='"+r3+"'";
  connection.query(sql3, function (err, result) {
    
      console.log("1 record updated");
    });
    res.send("1 day record successfully updated");
});});
