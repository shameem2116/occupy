  ...
  render(props) {
    return (
      ...
      <form action="http://localhost:7000/VIEW" method="post">
          ...
          <span style={{color: "red"}}>{this.state.errors1["fid0"]}</span> <br/>
   ...
   <option value="select">Select a YEAR</option>
        ...
        </select><br/> <span style={{color: "red"}}>{this.state.errors1["y0"]}</span> <br/>
      ...
      <form action="http://localhost:7000/INSERT" method="POST">
      ...
      <form action="http://localhost:7000/MODIFY" method="post">
